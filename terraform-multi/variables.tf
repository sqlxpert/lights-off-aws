...
variable "lights_off_stackset_operation_preferences" {
  ...
  description = "operation_preferences for the Lights Off CloudFormation StackSet and any automatically-defined StackSet instances. [DO NOT CHANGE this variable after module creation, until github.com/hashicorp/terraform-provider-aws/issues/39393 has been resolved.] See registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudformation_stack_set#operation_preferences-argument-reference and registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudformation_stack_set_instance#operation_preferences-argument-reference . The default region_order is lights_off_stackset_regions in alphabetic order. _percentage takes precedence over the corresponding _count . For the aws_cloudformation_stack_set resource, concurrency_mode is ignored. An output is provided so that you can reference the final operation_preferences in any manually-defined cloudformation_stack_set_instance resource definition(s)."
